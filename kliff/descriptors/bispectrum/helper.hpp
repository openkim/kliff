...
#define LOG_ERROR(msg)                                                                                                      \
    {                                                                                                                       \
        ...
        ss << msg;                                                                                                          \
        std::string _Messagef_(FormatMessageFileLineFunctionMessage("Error ", __FILE__, __LINE__, __FUNCTION__, ss.str())); \
        std::cerr << _Messagef_;                                                                                            \
    }

/*! \class _Array_Basic The basic STL like container similar to `std::vector` to handle multi-dimensional arrays.
 *
 * \brief An STL like container similar to <a href="https://en.cppreference.com/w/cpp/container/vector">std::vector</a>
...
public:
     ...
     *
     * \param count The size of the container
     * \param array The array of data to initialize elements of the container with.
     */
 ...
 *
 * \brief A 1-dimensional STL like container that encapsulates dynamic size arrays in a sequence container
 *
 * \tparam DataType The type of the elements. Default (double)
 */
template <class DataType = double>
...
public:
    ...
    /*!
     * \brief Returns the element at specified location \b i , with bounds checking.
     *
     * \param i Position of the element to return
     *
     * \return const DataType The requested element.
...
public:
    ...
    /*!
     * \brief Returns the element at specified location \b (i, j) , with bounds checking.
     *
     * \param i Position of the element in the 1st mode
     * \param j Position of the element in the 2nd mode
     *
    ...
    /*! \class j_operator A helper class to provide multidimensional array access semantics.
     *
     * \brief To provide 2-dimensional array access semantics, operator[] has to return a
     * reference to a 1D vector, which has to have its own operator[] which returns a
     ...
     *
     * \note
     * To provide multidimensional array access semantics, we are using multiple overloads for
     * \code operator[] \endcode . For speed one should avoid this complexity,
     * uses \code operator() \endcode as \code (i, j) \endcode directly.
     */
...
private:
    ...
    Array3DView<DataType> &operator=(Array3DView<DataType> const &other) = delete;
...
private:
    ...
    Array4DView<DataType> &operator=(Array4DView<DataType> const &other) = delete;
 ...
 *
 * \brief A 2-dimensional STL like container that encapsulates dynamic size arrays
 * with a 2-dimensional shape in a sequence container
 *
 * \tparam DataType The type of the elements. Default (double)
 */
template <class DataType = double>
...
public:
     ...
     * \param extentZero The extent of the container in the 1st mode
     * \param extentOne The extent of the container in the 2nd mode
     * \param array The array of data to initialize elements of the container in a row-major format.
     */
    Array2D(std::size_t const extentZero,
            std::size_t const extentOne,
            DataType const *array);
    ...
    /*!
     * \brief Resizes the container to contain \c extentZero times \c extentOne elements.
     *
     * \param extentZero
     * \param extentOne
     */
     ...
     * \param extentZero
     * \param extentOne
     * \param new_array The new array of data to initialize elements of the container with.
     */
...
public:
    ...
    inline void resize(int const extentZero, int const extentOne, int const extentTwo, DataType const new_value);

    inline void resize(int const extentZero, int const extentOne, int const extentTwo, DataType const *new_array);
...
public:
    ...
    inline void resize(int const extentZero, int const extentOne, int const extentTwo, int const extentThree);

    inline void resize(int const extentZero, int const extentOne, int const extentTwo, int const extentThree, DataType const new_value);

    inline void resize(int const extentZero, int const extentOne, int const extentTwo, int const extentThree, DataType const *new_array);
...
public:
    ...
    inline void resize(int const extentZero, int const extentOne, int const extentTwo, int const extentThree, int const extentFour);

    inline void resize(int const extentZero, int const extentOne, int const extentTwo, int const extentThree, int const extentFour, DataType const new_value);

    inline void resize(int const extentZero, int const extentOne, int const extentTwo, int const extentThree, int const extentFour, DataType const *new_array);
...
template <class DataType>
_Array_Basic<DataType>::_Array_Basic(std::size_t const count) : m(count, static_cast<DataType>(0)) {}
...
template <class DataType>
inline DataType const *_Array_Basic<DataType>::data() const noexcept { return m.data(); }

template <class DataType>
inline DataType *_Array_Basic<DataType>::data() noexcept { return m.data(); }
...
template <class DataType>
inline void _Array_Basic<DataType>::clear() noexcept { m.clear(); }

template <class DataType>
inline void _Array_Basic<DataType>::shrink_to_fit() { m.shrink_to_fit(); }

template <class DataType>
inline std::size_t _Array_Basic<DataType>::capacity() const noexcept { return m.capacity(); }

template <class DataType>
inline void _Array_Basic<DataType>::push_back(DataType const &value) { m.push_back(value); }

template <class DataType>
inline void _Array_Basic<DataType>::push_back(DataType &&value) { m.push_back(value); }
...
inline void _Array_Basic<DataType>::_range_check(int _n) const
{
    if (_n >= size())
    {
        LOG_ERROR("The input index is out of range! " + std::to_string(_n) + " >= " + std::to_string(size()));
        std::abort();
    }
}
...
inline void _Array_Basic<DataType>::_range_check(int _n, std::size_t tsize) const
{
    if (_n >= tsize)
    {
        LOG_ERROR("The input index is out of range! " + std::to_string(_n) + " >= " + std::to_string(tsize));
        std::abort();
    }
}

template <class DataType>
Array1DView<DataType>::Array1DView(std::size_t const count, DataType *array) : _extentZero(count), m(array) {}

template <class DataType>
Array1DView<DataType>::Array1DView(Array1DView<DataType> const &other) : _extentZero(other._extentZero), m(other.m) {}

template <class DataType>
Array1DView<DataType>::~Array1DView() {}

template <class DataType>
inline DataType const *Array1DView<DataType>::data() const noexcept { return m; }

template <class DataType>
inline DataType *Array1DView<DataType>::data() noexcept { return m; }

template <class DataType>
inline const DataType Array1DView<DataType>::operator()(int i) const { return m[i]; }

template <class DataType>
inline DataType &Array1DView<DataType>::operator()(int i) { return m[i]; }
...
template <class DataType>
const DataType Array1DView<DataType>::operator[](int i) const { return m[i]; }

template <class DataType>
DataType &Array1DView<DataType>::operator[](int i) { return m[i]; }
...
template <class DataType>
inline DataType const *Array2DView<DataType>::data() const noexcept { return m; }

template <class DataType>
inline DataType *Array2DView<DataType>::data() noexcept { return m; }
...
template <class DataType>
Array2DView<DataType>::j_operator::j_operator(Array2DView<DataType> &_array, int i) : j_array(_array), _i(i) {}
...
template <class DataType>
const typename Array2DView<DataType>::j_operator Array2DView<DataType>::operator[](int i) const { return j_operator(*this, i); }

template <class DataType>
typename Array2DView<DataType>::j_operator Array2DView<DataType>::operator[](int i) { return j_operator(*this, i); }
...
template <class DataType>
Array3DView<DataType>::Array3DView(Array3DView<DataType> const &other) : _extentZero(other._extentZero),
                                                                         _extentOne(other._extentOne),
...
template <class DataType>
inline DataType const *Array3DView<DataType>::data() const noexcept { return m; }

template <class DataType>
inline DataType *Array3DView<DataType>::data() noexcept { return m; }

template <class DataType>
inline Array2DView<DataType> Array3DView<DataType>::data_2D(int i)
{
    return Array2DView<DataType>(_extentOne, _extentTwo, m + i * _extentOne * _extentTwo);
}

template <class DataType>
inline Array1DView<DataType> Array3DView<DataType>::data_1D(int i, int j)
{
    return Array1DView<DataType>(_extentTwo, m + (i * _extentOne + j) * _extentTwo);
}

template <class DataType>
inline const DataType Array3DView<DataType>::operator()(int i, int j, int k) const
{
...
template <class DataType>
Array3DView<DataType>::j_operator::j_operator(Array3DView<DataType> &_array, int i) : j_array(_array), _i(i) {}

template <class DataType>
Array3DView<DataType>::j_operator::k_operator::k_operator(Array3DView<DataType> &_array, int i, int j) : k_array(_array), _i(i), _j(j) {}

template <class DataType>
const DataType Array3DView<DataType>::j_operator::k_operator::operator[](int k) const
{
...
template <class DataType>
const typename Array3DView<DataType>::j_operator::k_operator Array3DView<DataType>::j_operator::operator[](int j) const { return k_operator(j_array, _i, j); }

template <class DataType>
typename Array3DView<DataType>::j_operator::k_operator Array3DView<DataType>::j_operator::operator[](int j) { return k_operator(j_array, _i, j); }

template <class DataType>
const typename Array3DView<DataType>::j_operator Array3DView<DataType>::operator[](int i) const { return j_operator(*this, i); }

template <class DataType>
typename Array3DView<DataType>::j_operator Array3DView<DataType>::operator[](int i) { return j_operator(*this, i); }
...
template <class DataType>
Array4DView<DataType>::Array4DView(Array4DView<DataType> const &other) : _extentZero(other._extentZero),
                                                                         _extentOne(other._extentOne),
                                                                         _extentTwo(other._extentTwo),
...
template <class DataType>
inline DataType const *Array4DView<DataType>::data() const noexcept { return m; }

template <class DataType>
inline DataType *Array4DView<DataType>::data() noexcept { return m; }
...
template <class DataType>
inline const DataType Array4DView<DataType>::operator()(int i, int j, int k, int l) const
{
    std::size_t const _n = ((i * _extentOne + j) * _extentTwo + k) * _extentThree + l;
    return m[_n];
}
...
template <class DataType>
inline DataType const Array4DView<DataType>::at(int i, int j, int k, int l) const
{
    _range_check(i, _extentZero);
    _range_check(j, _extentOne);
    _range_check(k, _extentTwo);
...
template <class DataType>
Array4DView<DataType>::j_operator::j_operator(Array4DView<DataType> &_array, int i) : j_array(_array), _i(i) {}

template <class DataType>
Array4DView<DataType>::j_operator::k_operator::k_operator(Array4DView<DataType> &_array, int i, int j) : k_array(_array), _i(i), _j(j) {}

template <class DataType>
Array4DView<DataType>::j_operator::k_operator::l_operator::l_operator(Array4DView<DataType> &_array, int i, int j, int k) : l_array(_array), _i(i), _j(j), _k(k) {}

template <class DataType>
const DataType Array4DView<DataType>::j_operator::k_operator::l_operator::operator[](int l) const
{
    std::size_t const _n = ((_i * l_array._extentOne + _j) * l_array._extentTwo + _k) * l_array._extentThree + l;
    return l_array.m[_n];
}

template <class DataType>
DataType &Array4DView<DataType>::j_operator::k_operator::l_operator::operator[](int l)
{
    std::size_t const _n = ((_i * l_array._extentOne + _j) * l_array._extentTwo + _k) * l_array._extentThree + l;
    return l_array.m[_n];
}
...
template <class DataType>
const typename Array4DView<DataType>::j_operator::k_operator::l_operator Array4DView<DataType>::j_operator::k_operator::operator[](int k) const { return l_operator(k_array, _i, _j, k); }

template <class DataType>
typename Array4DView<DataType>::j_operator::k_operator::l_operator Array4DView<DataType>::j_operator::k_operator::operator[](int k) { return l_operator(k_array, _i, _j, k); }

template <class DataType>
const typename Array4DView<DataType>::j_operator::k_operator Array4DView<DataType>::j_operator::operator[](int j) const { return k_operator(j_array, _i, j); }

template <class DataType>
typename Array4DView<DataType>::j_operator::k_operator Array4DView<DataType>::j_operator::operator[](int j) { return k_operator(j_array, _i, j); }

template <class DataType>
const typename Array4DView<DataType>::j_operator Array4DView<DataType>::operator[](int i) const { return j_operator(*this, i); }

template <class DataType>
typename Array4DView<DataType>::j_operator Array4DView<DataType>::operator[](int i) { return j_operator(*this, i); }
...
template <class DataType>
Array2D<DataType>::Array2D() : _Array_Basic<DataType>(), _extentZero(0), _extentOne(0) {}
...
template <class DataType>
inline void Array2D<DataType>::resize(int const extentZero, int const extentOne, DataType const new_value)
{
    _extentZero = extentZero;
    _extentOne = extentOne;
    std::size_t const _n = _extentZero * _extentOne;
...
template <class DataType>
inline void Array2D<DataType>::resize(int const extentZero, int const extentOne, DataType const *new_array)
{
    _extentZero = extentZero;
    _extentOne = extentOne;
    std::size_t const _n = _extentZero * _extentOne;
...
template <class DataType>
Array2D<DataType>::j_operator::j_operator(Array2D<DataType> &_array, int i) : j_array(_array), _i(i) {}
...
template <class DataType>
const typename Array2D<DataType>::j_operator Array2D<DataType>::operator[](int i) const { return j_operator(*this, i); }

template <class DataType>
typename Array2D<DataType>::j_operator Array2D<DataType>::operator[](int i) { return j_operator(*this, i); }
...
template <class DataType>
inline void Array3D<DataType>::resize(int const extentZero, int const extentOne, int const extentTwo)
{
    _extentZero = extentZero;
    _extentOne = extentOne;
    _extentTwo = extentTwo;
...
template <class DataType>
inline void Array3D<DataType>::resize(int const extentZero, int const extentOne, int const extentTwo, DataType const new_value)
{
    _extentZero = extentZero;
    _extentOne = extentOne;
    _extentTwo = extentTwo;
...
template <class DataType>
inline void Array3D<DataType>::resize(int const extentZero, int const extentOne, int const extentTwo, DataType const *new_array)
{
    _extentZero = extentZero;
    _extentOne = extentOne;
    _extentTwo = extentTwo;
...
template <class DataType>
Array3D<DataType>::j_operator::j_operator(Array3D<DataType> &_array, int i) : j_array(_array), _i(i) {}

template <class DataType>
Array3D<DataType>::j_operator::k_operator::k_operator(Array3D<DataType> &_array, int i, int j) : k_array(_array), _i(i), _j(j) {}

template <class DataType>
const DataType Array3D<DataType>::j_operator::k_operator::operator[](int k) const
{
    std::size_t const _n = (_i * k_array._extentOne + _j) * k_array._extentTwo + k;
    return k_array.m[_n];
}
...
template <class DataType>
const typename Array3D<DataType>::j_operator::k_operator Array3D<DataType>::j_operator::operator[](int j) const { return k_operator(j_array, _i, j); }

template <class DataType>
typename Array3D<DataType>::j_operator::k_operator Array3D<DataType>::j_operator::operator[](int j) { return k_operator(j_array, _i, j); }

template <class DataType>
const typename Array3D<DataType>::j_operator Array3D<DataType>::operator[](int i) const { return j_operator(*this, i); }

template <class DataType>
typename Array3D<DataType>::j_operator Array3D<DataType>::operator[](int i) { return j_operator(*this, i); }

template <class DataType>
Array4D<DataType>::Array4D() : _Array_Basic<DataType>(),
                               _extentZero(0),
                               _extentOne(0),
                               _extentTwo(0),
                               _extentThree(0) {}
...
Array4D<DataType>::Array4D(std::size_t const extentZero,
                           std::size_t const extentOne,
                           std::size_t const extentTwo,
                           std::size_t const extentThree) : _Array_Basic<DataType>(extentZero * extentOne * extentTwo * extentThree),
                                                            _extentZero(extentZero),
                                                            _extentOne(extentOne),
                                                            _extentTwo(extentTwo),
                                                            _extentThree(extentThree) {}
...
Array4D<DataType>::Array4D(std::size_t const extentZero,
                           ...
                           std::size_t const extentTwo,
                           std::size_t const extentThree,
                           DataType const value) : _Array_Basic<DataType>(extentZero * extentOne * extentTwo * extentThree, value),
                                                   _extentZero(extentZero),
                                                   _extentOne(extentOne),
                                                   _extentTwo(extentTwo),
                                                   _extentThree(extentThree) {}
...
Array4D<DataType>::Array4D(std::size_t const extentZero,
                           ...
                           std::size_t const extentTwo,
                           std::size_t const extentThree,
                           DataType const *array) : _Array_Basic<DataType>(extentZero * extentOne * extentTwo * extentThree, array),
                                                    _extentZero(extentZero),
                                                    _extentOne(extentOne),
                                                    _extentTwo(extentTwo),
                                                    _extentThree(extentThree) {}
...
template <class DataType>
Array4D<DataType>::Array4D(Array4D<DataType> const &other) : _Array_Basic<DataType>(other),
                                                             _extentZero(other._extentZero),
                                                             _extentOne(other._extentOne),
                                                             _extentTwo(other._extentTwo),
                                                             _extentThree(other._extentThree) {}
...
template <class DataType>
Array4D<DataType>::Array4D(Array4D<DataType> &&other) : _Array_Basic<DataType>(std::move(other)),
                                                        _extentZero(other._extentZero),
                                                        _extentOne(other._extentOne),
                                                        _extentTwo(other._extentTwo),
                                                        _extentThree(other._extentThree) {}
...
template <class DataType>
Array4D<DataType> &Array4D<DataType>::operator=(Array4D<DataType> const &other)
{
    _Array_Basic<DataType>::operator=(other);
    _extentZero = other._extentZero;
    _extentOne = other._extentOne;
...
{
    std::size_t const _n = i * _extentOne * _extentTwo * _extentThree;
    return Array3DView<DataType>(_extentOne, _extentTwo, _extentThree, this->m.data() + _n);
}
...
template <class DataType>
inline void Array4D<DataType>::resize(int const extentZero, int const extentOne, int const extentTwo, int const extentThree)
{
    _extentZero = extentZero;
    _extentOne = extentOne;
    _extentTwo = extentTwo;
...
template <class DataType>
inline void Array4D<DataType>::resize(int const extentZero, int const extentOne, int const extentTwo, int const extentThree, DataType const new_value)
{
    _extentZero = extentZero;
    _extentOne = extentOne;
    _extentTwo = extentTwo;
...
template <class DataType>
inline void Array4D<DataType>::resize(int const extentZero, int const extentOne, int const extentTwo, int const extentThree, DataType const *new_array)
{
    _extentZero = extentZero;
    _extentOne = extentOne;
    _extentTwo = extentTwo;
...
template <class DataType>
inline const DataType Array4D<DataType>::operator()(int i, int j, int k, int l) const
{
    std::size_t const _n = ((i * _extentOne + j) * _extentTwo + k) * _extentThree + l;
    return this->m[_n];
}
...
template <class DataType>
Array4D<DataType>::j_operator::j_operator(Array4D<DataType> &_array, int i) : j_array(_array), _i(i) {}

template <class DataType>
Array4D<DataType>::j_operator::k_operator::k_operator(Array4D<DataType> &_array, int i, int j) : k_array(_array), _i(i), _j(j) {}

template <class DataType>
Array4D<DataType>::j_operator::k_operator::l_operator::l_operator(Array4D<DataType> &_array, int i, int j, int k) : l_array(_array), _i(i), _j(j), _k(k) {}

template <class DataType>
const DataType Array4D<DataType>::j_operator::k_operator::l_operator::operator[](int l) const
{
    std::size_t const _n = ((_i * l_array._extentOne + _j) * l_array._extentTwo + _k) * l_array._extentThree + l;
    return l_array.m[_n];
}
...
template <class DataType>
DataType &Array4D<DataType>::j_operator::k_operator::l_operator::operator[](int l)
{
    std::size_t const _n = ((_i * l_array._extentOne + _j) * l_array._extentTwo + _k) * l_array._extentThree + l;
    return l_array.m[_n];
}
...
template <class DataType>
const typename Array4D<DataType>::j_operator::k_operator::l_operator Array4D<DataType>::j_operator::k_operator::operator[](int k) const { return l_operator(k_array, _i, _j, k); }

template <class DataType>
typename Array4D<DataType>::j_operator::k_operator::l_operator Array4D<DataType>::j_operator::k_operator::operator[](int k) { return l_operator(k_array, _i, _j, k); }

template <class DataType>
const typename Array4D<DataType>::j_operator::k_operator Array4D<DataType>::j_operator::operator[](int j) const { return k_operator(j_array, _i, j); }

template <class DataType>
typename Array4D<DataType>::j_operator::k_operator Array4D<DataType>::j_operator::operator[](int j) { return k_operator(j_array, _i, j); }

template <class DataType>
const typename Array4D<DataType>::j_operator Array4D<DataType>::operator[](int i) const { return j_operator(*this, i); }

template <class DataType>
typename Array4D<DataType>::j_operator Array4D<DataType>::operator[](int i) { return j_operator(*this, i); }

template <class DataType>
Array5D<DataType>::Array5D() : _Array_Basic<DataType>(),
                               _extentZero(0),
                               _extentOne(0),
                               _extentTwo(0),
                               _extentThree(0),
...
Array5D<DataType>::Array5D(std::size_t const extentZero,
                           ...
                           std::size_t const extentTwo,
                           std::size_t const extentThree,
                           std::size_t const extentFour) : _Array_Basic<DataType>(extentZero * extentOne * extentTwo * extentThree * extentFour),
                                                           _extentZero(extentZero),
                                                           _extentOne(extentOne),
                                                           _extentTwo(extentTwo),
                                                           _extentThree(extentThree),
...
Array5D<DataType>::Array5D(std::size_t const extentZero,
                           ...
                           std::size_t const extentThree,
                           std::size_t const extentFour,
                           DataType const value) : _Array_Basic<DataType>(extentZero * extentOne * extentTwo * extentThree * extentFour, value),
                                                   _extentZero(extentZero),
                                                   _extentOne(extentOne),
                                                   _extentTwo(extentTwo),
                                                   _extentThree(extentThree),
...
Array5D<DataType>::Array5D(std::size_t const extentZero,
                           ...
                           std::size_t const extentThree,
                           std::size_t const extentFour,
                           DataType const *array) : _Array_Basic<DataType>(extentZero * extentOne * extentTwo * extentThree * extentFour, array),
                                                    _extentZero(extentZero),
                                                    _extentOne(extentOne),
                                                    _extentTwo(extentTwo),
                                                    _extentThree(extentThree),
...
template <class DataType>
Array5D<DataType>::Array5D(Array5D<DataType> const &other) : _Array_Basic<DataType>(other),
                                                             _extentZero(other._extentZero),
                                                             _extentOne(other._extentOne),
                                                             _extentTwo(other._extentTwo),
                                                             _extentThree(other._extentThree),
...
template <class DataType>
Array5D<DataType>::Array5D(Array5D<DataType> &&other) : _Array_Basic<DataType>(std::move(other)),
                                                        _extentZero(other._extentZero),
                                                        _extentOne(other._extentOne),
                                                        _extentTwo(other._extentTwo),
                                                        _extentThree(other._extentThree),
...
template <class DataType>
Array5D<DataType> &Array5D<DataType>::operator=(Array5D<DataType> const &other)
{
    _Array_Basic<DataType>::operator=(other);
    _extentZero = other._extentZero;
    _extentOne = other._extentOne;
...
{
    std::size_t const _n = i * _extentOne * _extentTwo * _extentThree * _extentFour;
    return Array4DView<DataType>(_extentOne, _extentTwo, _extentThree, _extentFour, this->m.data() + _n);
}

template <class DataType>
inline Array3DView<DataType> Array5D<DataType>::data_3D(int i, int j)
{
    std::size_t const _n = (i * _extentOne + j) * _extentTwo * _extentThree * _extentFour;
    return Array3DView<DataType>(_extentTwo, _extentThree, _extentFour, this->m.data() + _n);
}

template <class DataType>
inline Array2DView<DataType> Array5D<DataType>::data_2D(int i, int j, int k)
{
    std::size_t const _n = ((i * _extentOne + j) * _extentTwo + k) * _extentThree * _extentFour;
    return Array2DView<DataType>(_extentThree, _extentFour, this->m.data() + _n);
}

template <class DataType>
inline Array1DView<DataType> Array5D<DataType>::data_1D(int i, int j, int k, int l)
{
    std::size_t const _n = (((i * _extentOne + j) * _extentTwo + k) * _extentThree + l) * _extentFour;
    return Array1DView<DataType>(_extentFour, this->m.data() + _n);
}

template <class DataType>
inline void Array5D<DataType>::resize(int const extentZero, int const extentOne, int const extentTwo, int const extentThree, int const extentFour)
{
    _extentZero = extentZero;
    _extentOne = extentOne;
    _extentTwo = extentTwo;
    _extentThree = extentThree;
    _extentFour = extentFour;
    std::size_t const _n = _extentZero * _extentOne * _extentTwo * _extentThree * _extentFour;
    this->m.resize(_n, static_cast<DataType>(0));
}

template <class DataType>
inline void Array5D<DataType>::resize(int const extentZero, int const extentOne, int const extentTwo, int const extentThree, int const extentFour, DataType const new_value)
{
    _extentZero = extentZero;
    _extentOne = extentOne;
    _extentTwo = extentTwo;
...
template <class DataType>
inline void Array5D<DataType>::resize(int const extentZero, int const extentOne, int const extentTwo, int const extentThree, int const extentFour, DataType const *new_array)
{
    _extentZero = extentZero;
    _extentOne = extentOne;
    _extentTwo = extentTwo;
...
template <class DataType>
inline const DataType Array5D<DataType>::operator()(int i, int j, int k, int l, int n) const
{
    std::size_t const _n = (((i * _extentOne + j) * _extentTwo + k) * _extentThree + l) * _extentFour + n;
    return this->m[_n];
}

template <class DataType>
inline DataType &Array5D<DataType>::operator()(int i, int j, int k, int l, int n)
{
    std::size_t const _n = (((i * _extentOne + j) * _extentTwo + k) * _extentThree + l) * _extentFour + n;
    return this->m[_n];
}
...
template <class DataType>
inline DataType const Array5D<DataType>::at(int i, int j, int k, int l, int n) const
{
    this->_range_check(i, _extentZero);
    this->_range_check(j, _extentOne);
    this->_range_check(k, _extentTwo);
...
template <class DataType>
Array5D<DataType>::j_operator::j_operator(Array5D<DataType> &_array, int i) : j_array(_array), _i(i) {}

template <class DataType>
Array5D<DataType>::j_operator::k_operator::k_operator(Array5D<DataType> &_array, int i, int j) : k_array(_array), _i(i), _j(j) {}

template <class DataType>
Array5D<DataType>::j_operator::k_operator::l_operator::l_operator(Array5D<DataType> &_array, int i, int j, int k) : l_array(_array), _i(i), _j(j), _k(k) {}

template <class DataType>
Array5D<DataType>::j_operator::k_operator::l_operator::n_operator::n_operator(Array5D<DataType> &_array, int i, int j, int k, int l) : n_array(_array), _i(i), _j(j), _k(k), _l(l) {}

template <class DataType>
const DataType Array5D<DataType>::j_operator::k_operator::l_operator::n_operator::operator[](int n) const
{
    std::size_t const _n = (((_i * n_array._extentOne + _j) * n_array._extentTwo + _k) * n_array._extentThree + _l) * n_array._extentFour + n;
    return n_array.m[_n];
}

template <class DataType>
DataType &Array5D<DataType>::j_operator::k_operator::l_operator::n_operator::operator[](int n)
{
    std::size_t const _n = (((_i * n_array._extentOne + _j) * n_array._extentTwo + _k) * n_array._extentThree + _l) * n_array._extentFour + n;
    return n_array.m[_n];
}
...
template <class DataType>
const typename Array5D<DataType>::j_operator::k_operator::l_operator::n_operator Array5D<DataType>::j_operator::k_operator::l_operator::operator[](int l) const { return n_operator(l_array, _i, _j, _k, l); }

template <class DataType>
typename Array5D<DataType>::j_operator::k_operator::l_operator::n_operator Array5D<DataType>::j_operator::k_operator::l_operator::operator[](int l) { return n_operator(l_array, _i, _j, _k, l); }

template <class DataType>
const typename Array5D<DataType>::j_operator::k_operator::l_operator Array5D<DataType>::j_operator::k_operator::operator[](int k) const { return l_operator(k_array, _i, _j, k); }

template <class DataType>
typename Array5D<DataType>::j_operator::k_operator::l_operator Array5D<DataType>::j_operator::k_operator::operator[](int k) { return l_operator(k_array, _i, _j, k); }

template <class DataType>
const typename Array5D<DataType>::j_operator::k_operator Array5D<DataType>::j_operator::operator[](int j) const { return k_operator(j_array, _i, j); }

template <class DataType>
typename Array5D<DataType>::j_operator::k_operator Array5D<DataType>::j_operator::operator[](int j) { return k_operator(j_array, _i, j); }

template <class DataType>
const typename Array5D<DataType>::j_operator Array5D<DataType>::operator[](int i) const { return j_operator(*this, i); }

template <class DataType>
typename Array5D<DataType>::j_operator Array5D<DataType>::operator[](int i) { return j_operator(*this, i); }
