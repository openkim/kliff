...
public:
     ...
     *
     * For example eq(5) of ``Gaussian Approximation Potentials: The Accuracy of Quantum
...
private:
     ...
     *
     * \param n A positive integer number greater than 0 and less than nmaxfactorial \sa @nmaxfactorial
     *
    ...
    /*!
     * \brief Write the list values of Clebsch-Gordan coefficients using notation of VMK Table 8.11
     *
     ...
     * \param r
     */
    void compute_uarray(double const x, double const y, double const z, double const z0, double const r);
