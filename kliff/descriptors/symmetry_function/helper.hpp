 ...
 * \param endOfFileFlag Flag to indicate that we have reached the end of the file
 */
 ...
 *
 * \note
 * The argument should first be converted to `unsigned char`, since the behavior of `std::tolower`
