...
# training set
tset = Dataset("../tests/calculators/Si_T300_4/")
configs = tset.get_configs()

# calculators
calc1 = Calculator(model_name="Three_Body_Stillinger_Weber_Si__MO_405512056662_004")
calc1.create(configs)
calc1.set_fitting_params(A=[[16.0, 1.0, 20]], B=[["DEFAULT"]])
calc2 = Calculator(model_name="Three_Body_Stillinger_Weber_Si__MO_405512056662_004")
