# -*- coding: utf-8 -*-
#
# kliff documentation build configuration file, created by
...
html_theme_options = {
    # "rightsidebar": "true",
    # "relbarbgcolor": "black"
    'logo_only': True,  # if we have a html_logo below, this shows /only/ the logo
                        # with no title text
}
...
htmlhelp_basename = 'kliff-fitdoc'
...
latex_documents = [
    (master_doc, 'kliff.tex', u'kliff Documentation',
...
man_pages = [
    (master_doc, 'kliff', u'kliff Documentation',
     [author], 1)
]
